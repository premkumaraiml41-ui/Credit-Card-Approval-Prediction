...
![GitHub last commit](https://img.shields.io/github/last-commit/premkumar_ul/Credit-card-approval-prediction-classification)
![GitHub repo size](https://img.shields.io/github/repo-size/premkumar_ul/Credit-card-approval-prediction-classification)
...
[![Streamlit App](https://static.streamlit.io/badges/streamlit_badge_black_white.svg)](https://share.streamlit.io/premkumar_ul/credit-card-approval-prediction-classification/main/cc_approval_pred.py)
...
- [premkumarui](https://github.com/premkumaraiml41-ui)
...
```bash
git clone https://github.com/premkumar_ul/Credit-card-approval-prediction-classification.git
```
...
To explore the notebook file [here](https://nbviewer.org/github/premkumar_ul/Income-classification/blob/master/Income_Classification.ipynb)
